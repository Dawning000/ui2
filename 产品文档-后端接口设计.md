...
#### 3.3.1.1 获取电影列表（使用 /movies/list 接口）
```
GET /api/movies/list?page=1&size=10&tag=动作&year=2024&rating=8.0&actor=演员名&award=奥斯卡
...
#### 3.5.1 获取综艺列表
```
GET /api/varieties?page=1&size=10&genre=真人秀&year=2024&rating=8.0&host=主持人名&guest=嘉宾名
