  ...
  <div class="movie-form-overlay" @click.self="handleCancel">
    <div class="movie-form-modal">
      ...
      <form @submit.prevent="handleSubmit" class="movie-form">
        ...
        <div class="form-group">
          <label>参演嘉宾 <span class="required">*</span></label>
        ...
        <div class="form-group">
          <label>节目简介 <span class="required">*</span></label>
          <textarea 
            v-model="form.summary" 
            required 
            placeholder="请输入综艺节目简介"
            rows="6"
          ></textarea>
        </div>
...
import type { VarietySaveData, VarietyActor } from '@/api/varieties'

// Props
interface Props {
  isEdit: boolean
  initialData?: VarietySaveData
}
...
const emit = defineEmits<{
  submit: [data: VarietySaveData]
  cancel: []
}>()

// 表单数据
const form = reactive<VarietySaveData>({
